...
summary: "Tzimisce-rooted patrol and defense pack"
tags:
  - "reference"
  - "Sabbat"
visibility: players
...
---
# The Knights of St. Boris Krzyzews

## Overview

Tzimisce-rooted patrol and defense pack
...
| Nature | Sabbat Pack |
| Allegiance | Sabbat |
| Primary Territory | The Knights of St. |
| Known Members | 6 named members |
...
| --- | --- |
| Allegiance | Sabbat |
| Role In The City | Tzimisce-rooted patrol and defense pack |
| Storyteller Use | Use The Knights of St. Boris Krzyzews as a Sabbat pack with its own politics, wounds, and pressure on Los Angeles. |
...
Symbol or group image pending for The Knights of St. Boris Krzyzews.

## Roleplaying Notes

The Knights of St. Boris Krzyzews should read as a complete Sabbat pack, not a single NPC. Let the history define the pack's pressure on the city and let the member entries show how that pressure becomes personal.

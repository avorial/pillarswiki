...
type: organization
name: "Abramelin Oil"
summary: "Noddist priestly pack and Sabbat spiritual authority"
tags:
  - "reference"
  - "Sabbat"
visibility: players
...
Noddist priestly pack and Sabbat spiritual authority
...
| Nature | Sabbat Pack |
| Allegiance | Sabbat |
| Primary Territory | Abramelin Oil maintains influence less through territory than through doctrine, ritual authority, and access to the upper reaches of Sabbat religious politics. |
...
| --- | --- |
| Allegiance | Sabbat |
| Role In The City | Noddist priestly pack and Sabbat spiritual authority |
| Storyteller Use | Use Abramelin Oil as a Sabbat pack with its own politics, wounds, and pressure on Los Angeles. |
...
Symbol or group image pending for Abramelin Oil.

## Roleplaying Notes

Abramelin Oil should read as a complete Sabbat pack, not a single NPC. Let the history define the pack's pressure on the city and let the member entries show how that pressure becomes personal.

...
type: organization
name: "The Answer"
summary: "Watch Commander pack and Sabbat intelligence arm"
tags:
  - "reference"
  - "Sabbat"
visibility: players
...
Watch Commander pack and Sabbat intelligence arm
...
| Nature | Sabbat Pack |
| Allegiance | Sabbat |
| Primary Territory | The Answer operate from Los Angeles, but they still think like nomads. |
| Known Members | 7 named members |
...
| --- | --- |
| Allegiance | Sabbat |
| Role In The City | Watch Commander pack and Sabbat intelligence arm |
| Storyteller Use | Use The Answer as a Sabbat pack with its own politics, wounds, and pressure on Los Angeles. |
...
Symbol or group image pending for The Answer.

## Roleplaying Notes

The Answer should read as a complete Sabbat pack, not a single NPC. Let the history define the pack's pressure on the city and let the member entries show how that pressure becomes personal.

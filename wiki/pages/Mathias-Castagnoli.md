...
summary: "Nosferatu spy, Cold War survivor, and investigator of hidden systems"
tags:
  - "dossier"
  - "Nosferatu"
visibility: players
...
keyLinks: []
aliases: []
cover: "Mathias_Castagnoli.png"
lastEditedBy: "Codex import from pillarswiki"
---
# Mathias Castagnoli

![Portrait of Mathias Castagnoli](/wiki/media/Mathias_Castagnoli.png)

## Overview

Nosferatu spy, Cold War survivor, and investigator of hidden systems
...
| Apparent Age | Adult; strikingly handsome from the neck up, grotesquely altered below |
| Alternate Identity | Aaron Matthews, insurance investigator. |
...
| Merits Flaws | Hidden Advantage, Natural Linguist, Unmarred Face, Awkward Mobility, Derangement, Stolen Potential |

...
summary: "Streetwise investigator, information seller, and returned Los Angeles tail"
tags:
  - "dossier"
  - "Nosferatu"
visibility: players
...
![Portrait of Jackie the Tail](/wiki/media/Jackie_the_Tail.png)

## Overview

Streetwise investigator, information seller, and returned Los Angeles tail

- Clan / sphere: Nosferatu
...
| Generation | 12th |
| Embrace | Unknown |
| Apparent Age | Hard to determine beneath the Nosferatu curse |
...
| Merits Flaws | False Reflection, Master of the Sewers, Notoriety, Weak-Willed, Lesser Generation |
...
Jackie is visibly Nosferatu, malformed and unsettling, but he has learned to carry his ugliness with the weary nonchalance of a man who stopped asking the world for approval long ago. His clothes are practical, layered, and suited to trainyards, tunnels, back alleys, and public spaces where nobody looks too closely.

...
type: npc
name: "Marcus Jonak"
summary: "Toreador operator, cultural broker, and Los Angeles courtier"
tags:
  - "dossier"
  - "Toreador"
visibility: players
...
![Portrait of Marcus Jonak](/wiki/media/Marcus_Jonak.png)

## Overview

Toreador operator, cultural broker, and Los Angeles courtier

- Clan / sphere: Toreador
...
| Apparent Age | A handsome young film star from another age, preserved at the height of promise |
...
| Secondary Abilities | Disguise 1 |
...
| Other Powers | Technique: Quickened Blood |
...
| Merits Flaws | Artist's Blessing, Monopoly, Master of Puppets, Machiavellian Prodigy, Dark Secret |
...
Marcus looks like old Hollywood never ended, only grew more expensive. His suits are cut with modern precision but worn with the ease of a studio-era leading man. His smile is warm, camera-ready, and often sincere enough to be dangerous. He maintains the posture of someone who expects to be noticed even when trying not to be. In moments of stress, the charm tightens into calculation, as though a director inside him has suddenly demanded another take.

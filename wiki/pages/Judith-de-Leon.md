...
type: npc
name: "Judith de Leon"
summary: "Toreador power broker, patron, and courtly survivor"
tags:
  - "dossier"
  - "Toreador"
visibility: players
...
![Portrait of Judith de Leon](/wiki/media/Judith_de_Leon.png)

## Overview

Toreador power broker, patron, and courtly survivor
...
| Apparent Age | Difficult to judge; composed, courtly, and plainly out of another age |
...
| Merits Flaws | Artist's Blessing, Architect of the Tower, Reputation, Prestigious Sire, Fragile Bones, Archaic, Methuselah's Thirst |

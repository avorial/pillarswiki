...
summary: "Tremere Regent, relic hunter, and former Ventrue ghoul turned Pyramid loyalist"
tags:
  - "dossier"
  - "Tremere"
visibility: players
...
![Portrait of Regent Pedro Villalobos](/wiki/media/Regent_Pedro_Villalobos.png)

## Overview

Tremere Regent, relic hunter, and former Ventrue ghoul turned Pyramid loyalist
...
| Apparent Age | Difficult to place precisely; an elder bearing shaped more by severity than age |
...
| Merits Flaws | Talisman, Additional Common Discipline: Fortitude, Notoriety, Intolerance: Ventrue but not their servants, Bound to the Earth: Granada, Spain |
